...
Psy::Analysis::Blossum2 - The great new Psy::Analysis::Blossum2!
...
Perhaps a little code snippet.
    ...
    use Psy::Analysis::Blossum2;

    my $foo = Psy::Analysis::Blossum2->new();
    ...
...
C<bug-psy-analysis-blossum2@rt.cpan.org>, or through the web interface at
...
1; # End of Psy::Analysis::Blossum2
